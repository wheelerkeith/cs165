...
void bind(Piece * pThis, PieceType pt, bool isWhite)
{
   ...
   static VTablePiece vTablePieceKing  = { &getLetterKing  };
   static VTablePiece vTablePieceQueen = { &getLetterQueen };
   static VTablePiece vTablePiecePawn  = { &getLetterPawn  };

   switch (pt)
   {
      case KING:
         pThis->__vtptr = &vTablePieceKing;
         break;
      case QUEEN:
         pThis->__vtptr = &vTablePieceQueen;
         break;
      case PAWN:
         pThis->__vtptr = &vTablePiecePawn;
         break;
      default:
         assert(false);
   }
